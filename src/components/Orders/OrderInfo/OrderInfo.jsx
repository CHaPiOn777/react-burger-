...
console.log(priceOrder, conformityIngredients)
  const activeClass = () => {
    ...
    <>
      {conformityIngredients &&
        <div className={style.orderInfo}>
          ...
          <p className={`${activeClass()} text text_type_main-small mt-3`}>{conformityIngredients.status}</p>
          ...
          <div className={`${style.data} mt-10`}>
            <p className="text text_type_main-small text_color_inactive">{conformityIngredients.createdAt}</p>
